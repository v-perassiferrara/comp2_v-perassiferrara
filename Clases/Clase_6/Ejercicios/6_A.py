...
fifo_write = "/tmp/chat_a"  # FIFO para enviar mensaje a user2
fifo_read = "/tmp/chat_b"   # FIFO para leer mensaje de user2
...
while True:
    ...
    msg = input("A: ")  # El usuario ingresa un mensaje
    ...
    if respuesta == "/exit":
        print("B ha salido del chat.")
        os.close(fr)
        break
    
    print(f"B: {respuesta}")  # Mostrar respuesta
